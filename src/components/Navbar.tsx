...
const Navbar = () => {
  ...
  const NavLinks = () => (
    <>
                ...
                <Menu.Item>
                  {({ active }) => (
                    ...
                    >
                      ...
                      AI Карьерный Ментор
                      <span className="ml-auto px-1.5 py-0.5 text-xs font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full">Новое</span>
                    </Link>
                  )}
                </Menu.Item>
                <Menu.Item>
      ...
      {user && userData?.role && ['employer', 'business'].includes(userData.role) && (
        <Link
